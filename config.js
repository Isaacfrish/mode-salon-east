...
function renderNav(activePage) {
  ...
  <nav>
    <div class="nav-logo">${BUSINESS.shortName} <span>${BUSINESS.highlightName}</span></div>
    <ul class="nav-links">
  ...
  <footer>
    <div style="max-width: 1100px; margin: 0 auto;">
      <div class="footer-grid">
        <div>
          <div class="footer-logo">${BUSINESS.shortName} <span>${BUSINESS.highlightName}</span></div>

...
function renderNav(activePage) {
  return `
  <div class="info-bar">
    <span style="font-size: 0.95rem;">📍 ${BUSINESS.address.full}</span>
    <a href="tel:${BUSINESS.phoneRaw}" style="font-size: 0.95rem;">📞 ${BUSINESS.phone}</a>
    <span style="font-size: 0.95rem;">⏰ ${BUSINESS.hoursShort}</span>
  </div>
  <nav>
    <div class="nav-logo" style="flex: 0 0 auto; margin-right: 80px;"><img src="https://isaacfrish.github.io/mode-salon-east/logo.png" alt="${BUSINESS.name}" style="height:48px; width:auto; object-fit:contain; vertical-align:middle;"/></div>
    <ul class="nav-links">
      ...
      <li><a href="booking.html" class="nav-cta" style="padding: 10px 20px; margin-left: 12px; white-space: nowrap;">Book Now</a></li>
    </ul>
